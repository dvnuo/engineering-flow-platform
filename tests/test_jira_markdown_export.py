...
def test_output_directory_workspace_guard(tmp_path, monkeypatch):
    ...
    ok = _resolve_output_directory("/root/.efp/workspace/FXOW/FXLanding")
    assert str(ok).endswith("/root/.efp/workspace/FXOW/FXLanding")
    with pytest.raises(ValueError):
        _resolve_output_directory("/etc")
    with pytest.raises(ValueError):
        _resolve_output_directory("/root/.ssh")
    with pytest.raises(ValueError):
        _resolve_output_directory("/root/.efp/workspace/../.ssh")
