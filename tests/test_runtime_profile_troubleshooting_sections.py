"""Projection of the troubleshooting sections (nexus/splunk/pgsql).

nexus and splunk are multi-instance products like jira: the Portal shape
...
def test_portal_field_tree_and_overlay_sections_accept_the_new_sections():
    for section in ("nexus", "splunk", "pgsql"):
