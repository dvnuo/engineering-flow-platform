            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "jql": {"type": "string",
                                "description": "Optional JQL query string (alternative to using 'input' with a dict)"},
                        "page_size": {"type": "integer", "description": "Optional page size when using JQL",
                                      "default": 50},
                        "output_mode": {"type": "string",
                                        "enum": ["single_combined", "one_file_per_issue", "zip_per_issue"],
                        ...
                        "attachments_concurrency": {"type": "integer",
                                                    "description": "Concurrent downloads for attachments",
                                                    "default": 4},
                        "attachments_max_size": {"type": "integer",
                                                 "description": "Maximum attachment download size in bytes",
                                                 "default": 52428800},
                        "attachments_inline_text_threshold": {"type": "integer",
                                                              "description": "Max chars for inline text embedding",
                                                              "default": 2000},
                        "attachments_retries": {"type": "integer",
                                                "description": "Retry attempts for attachment downloads", "default": 3},
                        "attachments_backoff": {"type": "array", "items": {"type": "integer"},
                                                "description": "Backoff seconds for retries", "default": [1, 2, 4]},
                        "attachments_preserve_binary": {"type": "boolean",
                                                        "description": "Whether to preserve and copy the original binary files",
                                                        "default": True},
                        "include_raw_snapshot": {"type": "boolean",
                                                 "description": "Include a raw fields snapshot in the Markdown"},
                        "max_comments": {"type": "integer", "description": "Maximum number of comments to include",
                                         "default": 10},
                        "comments_order": {"type": "string", "enum": ["latest_first", "oldest_first"],
                                           "default": "latest_first"},
                        "field_match_threshold": {"type": "number",
                                                  "description": "Similarity threshold for custom field matching",
                                                  "default": 0.9},
                        "field_similarity_threshold": {"type": "number",
