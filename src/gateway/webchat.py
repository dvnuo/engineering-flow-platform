...
async def api_chat(request: web.Request) -> web.Response:
    ...
    POST /api/chat
    Body: {"message": "...", "session_id": "optional", "message_id": "optional", "attachments": ["file_id1", "file_id2"], "reasoning_replay": false}
    """
    try:
        ...
        # Frontend-provided message ID (UUID generated by frontend)
        ...
        result = await agent.process(
            ...
            message_id=message_id,  # Frontend-provided message ID
        )
...
async def api_chat_stream(request: web.Request) -> web.StreamResponse:
    ...
    POST /api_chat/stream
    Body: {"message": "...", "session_id": "optional", "message_id": "optional"}
    ...
    try:
        ...
        message = (data.get('message') or '').strip()
        session_id = data.get('session_id', f'webchat_{datetime.utcnow().strftime("%Y%m%d_%H%M%S")}')
        message_id = data.get('message_id', None)  # Frontend-provided message ID
