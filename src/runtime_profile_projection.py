...
RUNTIME_PROFILE_CLI_TOOL_INSTRUCTIONS = (
    ...
    "appd for AppDynamics (`appd app list --json`, `appd snapshot list --app <app> --duration-mins 60 --errors-only --json`, `appd violation list --app <app> --duration-mins 60 --json`), "
    "and pgsql for PostgreSQL (`pgsql schema tables --json`, `pgsql query --sql \"select ...\" --limit 200 --json`; queries run in a read-only transaction). "
