...
This module provides automatic session summarization using LLM,
saving conversation summaries to daily memory files.
...
async def summarize_session_with_llm(
    ...
    """Use LLM to summarize session conversation.
...
async def save_session_summary(
    ...
    It summarizes the conversation using LLM and saves to memory.
    ...
    try:
        ...
        summary = await summarize_session_with_llm(session_id, history)
