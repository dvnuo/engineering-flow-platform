...
As a senior developer, follow these practices:

### Code Changes
1. **Understand before coding** - Read existing code, understand the structure
2. **Make small, focused changes** - One feature/bug per change
3. **Test your changes** - Run existing tests, verify manually if needed
4. **Commit with meaningful messages** - Clear description of what/why
...
- Write PR descriptions that explain the change
- Link related issues

### Debugging
- Read error messages carefully
- Check logs first (`logs/efp.log` for the platform)
- Use minimal reproduction steps
- When stuck, ask for help with context

### Deployment (to VM)
- Test locally first
- Commit and push changes
- SSH to VM and pull/deploy
